  ...
  <body>
      ...
      <div class="nav-wrapper">
        <div class="col s12" id="navbar">
          ...
          <a href="ca.php" class="breadcrumb">CA</a>
  	...
  	<div class="container" style="margin-right: 300px;">
        <a href="class.php" onclick="window.open(this.href, 'Snopzer','toolbar=1,resizable=0'); return false;">
                ...
                <div class="card" id="grey" style="width: 1200px;">
                  <div class="card-content white-text" style="padding-bottom: 50px; height: 150px;">
                    ...
                    <div class="col s6 pull-s3" style="padding-top: 25px;">
                      <span class="card-title" style="font-size: 60px; color: #000000; font-weight: 100px;">FCP COMP B</span>
                    </div>
                  </div>
                </div>
            </div>
            ...
            <div class="col s12 m6">
                <div class="card" id="darkgrey" style="width: 1200px;">
                  <div class="card-content white-text" style="padding-bottom: 50px; height: 150px;">
                    ...
                    <div class="col s6 pull-s3" style="padding-top: 25px;">
                      <span class="card-title" style="font-size: 60px; color: #000000; font-weight: 100px;">DS COMP A</span>
                    </div>
                  </div>
                </div>
            </div>
