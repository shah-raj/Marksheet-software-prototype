              ...
              <div class="card" id="grey" style="width: 1200px;">
                <div class="card-content white-text" style=" height: 150px;">
                  ...
                  <div class="col s6 pull-s3" style="padding-top: 25px;">
                    <span class="card-title" style="font-size: 60px; color: white; font-weight: 100px;">FIRST YEAR</span>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="col s12 m6">
              <div class="card" id="darkgrey" style="width: 1200px;">
                <div class="card-content white-text" style="padding-bottom: 50px; height: 150px;">
                  ...
                  <div class="col s6 pull-s3" style="padding-top: 25px;">
                    <span class="card-title" style="font-size: 60px; color: white; font-weight: 100px;">SECOND YEAR</span>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="col s12 m6">
              <div class="card" id="grey" style="width: 1200px;">
                <div class="card-content white-text" style="padding-bottom: 50px; height: 150px;">
                  ...
                  <div class="col s6 pull-s3" style="padding-top: 25px;">
                    <span class="card-title" style="font-size: 60px; color: white; font-weight: 100px;">THIRD YEAR</span>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="col s12 m6">
              <div class="card" id="darkgrey" style="width: 1200px;">
                <div class="card-content white-text" style="padding-bottom: 50px; height: 150px;">
                  ...
                  <div class="col s6 pull-s3" style="padding-top: 25px;">
                    <span class="card-title" style="font-size: 60px; color: white; font-weight: 100px;">LAST YEAR</span>
                  </div>
                </div>
              </div>
          </div>
