...
<html lang="en">
  ...
  <body >
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark " style="float: right;">
      <a class="navbar-brand inactiveLink" href="" style="float: right; color: white;">FCP COMP B3<br>123456789</a>
    </nav>
    <div class = "main"> 
      <form >
        <?php
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark " id ="footer">
      <a class="navbar-brand inactiveLink" href="" style="color: white; margin-left: 50px;">FCP COMP B3 (123456789)</a>
      <span style="font-size: 20px; padding-left: 180px;">RNP: __________</span>
      <a class="navbar-brand inactiveLink" href="" style="color: white; display: inline-block; margin: 0 auto;">VPV:__________</a>
      <!-- <a class="navbar-brand inactiveLink" href="" style="color: white; display: inline-block; ">RNP</a> -->
